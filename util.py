...
# def get_tf_image_from_base64_string(b64str):
#     # Decode the base64 string
#     image_data = tf.keras.preprocessing.image.img_to_array(tf.keras.preprocessing.image.load_img(b64str,target_size=(224, 224)))
#     return image_data
...
if __name__ == '__main__':
    ...
    print(classify_image(None, 'test_images/burger.jpg'))